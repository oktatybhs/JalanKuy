    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sLokasi != null && sTanggalCI != null && sTanggalCO != null && sKamar != null)
                    if ((sLokasi.equalsIgnoreCase("jakarta"))
                            || (sLokasi.equalsIgnoreCase("bandung"))
                            || (sLokasi.equalsIgnoreCase("purwokerto"))
                            || (sLokasi.equalsIgnoreCase("yogyakarta"))
                            || (sLokasi.equalsIgnoreCase("surabaya"))) {
                    } else {
                        AlertDialog dialog = new AlertDialog.Builder(BookHotelActivity.this)
                                ...
                                .setPositiveButton("Ya", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        try {
                                            db.execSQL("INSERT INTO TB_BHTL (lokasi, hotel, tanggalci, tanggalco, kamar, orang) VALUES ('" +
                                                    sLokasi + "','" +
                                                    sTanggalCI + "','" +
                                                    sTanggalCO + "','" +
                                                    sKamar + "','" +
                                            ...
                                            db.execSQL("INSERT INTO TB_HARGA (username, id_bhtl, harga_kamar, harga_orang, harga_total_hotel) VALUES ('" +
                                                    email + "','" +
                                                    id_book_hotel + "','" +
                                                    hargaTotalKamar + "','" +
                                                    hargaTotalOrang + "','" +
